...
export const SOURCES: Source[] = [
  ...
  },
  {
    ...
    rss: ['https://www.thequint.com/rss/India.xml'],
    lean: 'left_lean',
    language: 'en',
    factuality: 'mostly',
    notes:
  ...
  },
  {
    ...
    rss: ['https://caravanmagazine.in/rss'],
    lean: 'left_heavy',
    language: 'en',
    factuality: 'high',
    notes:
  ...
  },
  {
    ...
    rss: ['https://www.thenewsminute.com/rss.xml'],
    lean: 'left_lean',
    language: 'en',
    factuality: 'mostly',
    notes:
  ...
  },
  {
    ...
    rss: ['https://feeds.feedburner.com/indian-express-news-latest'],
    lean: 'centre',
    language: 'en',
    factuality: 'high',
    notes:
